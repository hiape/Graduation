...
int main(int argc,char **argv)
{
	...
	// //创建VOIP数据类
	// PcmData pcm_data(encoder_factory_ptr->CreateEncoder(),encryption_factory_ptr->CreateEncryption(),wav_file);
	...
	InFile wav_file("music.wav");
	std::cout<<wav_file.GetFileSize()<<std::endl;
	return 0;
}